...
def main():
    ...
    adults=['LJ','Toby','Alvin F','Nini','Val','Dulce','Nanay ni My','Lolo Dad','Lola Mah','V','Khetz','Tomas','Bing','Josie','Andrew','Ness','Nyer','Ednil','Raymund','Jeanet','Shayla','Karlo','Jerose','Ricky','Leah','Chris','Apol','Myra','Alvin R','Tere','Ron']
    #cloud(orig_kids)
    cloud(adults)
