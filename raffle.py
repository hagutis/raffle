...
def main():
    ...
    orig_kids=['Aaron','Abbey','Abby','Aedan','Amielle','Annika','Ardene','Arianne','Ava','Cedrick','Chaskell','Christoff','Edmund','Izzy','Jasen','Jasmine','Luigi','Matt','Nathan','Niall','Raiden','Rye','Shiloh','TJ']
