...
def main():
    ...
    orig_kids=['Abbey','Aedan','Amielle','Annika','Ardene','Arianne','Ava','Cedrick','Chaskell','Christoff','Edmund','Izzy','Jasen','Jasmine','Luigi','Matt','Nathan','Niall','Raiden','Rye','Shiloh','TJ']
